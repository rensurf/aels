...
source .env
ENV_VARS="Variables={TELEGRAM_BOT_TOKEN=$TELEGRAM_BOT_TOKEN,OPENAI_API_KEY=$OPENAI_API_KEY,ANTHROPIC_API_KEY=$ANTHROPIC_API_KEY,COSMOS_ENDPOINT=$COSMOS_ENDPOINT,COSMOS_KEY=$COSMOS_KEY,COSMOS_DATABASE=$COSMOS_DATABASE,COSMOS_GRAPH=$COSMOS_GRAPH,DYNAMODB_SESSION_TABLE=$DYNAMODB_SESSION_TABLE,SQS_WORKER_QUEUE_URL=$SQS_WORKER_QUEUE_URL,WEB_API_KEY=$WEB_API_KEY,WEB_USER_ID=$WEB_USER_ID}"
